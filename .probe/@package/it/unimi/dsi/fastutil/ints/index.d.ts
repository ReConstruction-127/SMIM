...
import { $Spliterator$OfInt, $SortedMap, $Map, $Map$Entry, $ListIterator, $Spliterator, $List, $Collection_, $Collection, $Comparator, $Set, $Iterator, $PrimitiveIterator$OfInt, $AbstractCollection } from "@package/java/util";
...
declare module "@package/it/unimi/dsi/fastutil/ints" {
    ...
    export interface $Int2DoubleMap extends $Int2DoubleFunction, $Map<number, number> {
        ...
        mergeDouble(arg0: number, arg1: number, arg2: $DoubleBinaryOperator): number;
