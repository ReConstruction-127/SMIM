...
import { $Function as $Function$1, $DoubleToLongFunction, $DoubleToIntFunction, $DoubleUnaryOperator, $DoubleFunction, $Function_, $DoublePredicate } from "@package/java/util/function";
