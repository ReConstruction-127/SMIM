...
import { $ListIterator, $Spliterator, $List, $Collection, $Spliterator$OfDouble, $Comparator, $Iterator, $PrimitiveIterator$OfDouble } from "@package/java/util";
