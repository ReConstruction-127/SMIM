...
import { $Function as $Function$1, $BiConsumer_, $UnaryOperator_, $ToIntFunction_, $Consumer_, $Predicate_, $ToDoubleFunction, $Predicate, $ToIntFunction, $Function_, $IntBinaryOperator_, $BiFunction_, $ToLongFunction } from "@package/java/util/function";
