...
declare module "@package/com/mojang/serialization" {
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.EnchantmentProviderType | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.BlockType | RegistryTypes.MekanismRobitSkinSerializer | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.MekanismChemicalIngredientType | RegistryTypes.WorldgenBiomeSource | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.FunctionalstorageFunctionalUpgradeBehavior | RegistryTypes.EntitySubPredicateType | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.WorldgenMaterialRule;
     ...
     */
    export type $DataResult$Error_<R> = { partialValue?: (R) | undefined, messageSupplier?: $Supplier_<string>, lifecycle?: $Lifecycle,  } | [partialValue?: (R) | undefined, messageSupplier?: $Supplier_<string>, lifecycle?: $Lifecycle, ];
    ...
    export interface $MapCodec<A> extends RegistryMarked<RegistryTypes.WorldgenMaterialRuleTag, RegistryTypes.WorldgenMaterialRule> {}
