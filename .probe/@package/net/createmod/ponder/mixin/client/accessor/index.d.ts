...
import { $ParticleProvider, $ParticleProvider_ } from "@package/net/minecraft/client/particle";
...
declare module "@package/net/createmod/ponder/mixin/client/accessor" {
     ...
     */
    export type $ParticleEngineAccessor_ = (() => $Map_<$ResourceLocation_, $ParticleProvider_<never>>);
