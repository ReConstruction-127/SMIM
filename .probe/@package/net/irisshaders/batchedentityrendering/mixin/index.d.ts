import { $MultiBufferSource$BufferSource, $RenderType, $RenderStateShard$TransparencyStateShard } from "@package/net/minecraft/client/renderer";
...
declare module "@package/net/irisshaders/batchedentityrendering/mixin" {
    ...
    /**
     * Values that may be interpreted as {@link $CompositeStateAccessor}.
     */
    export type $CompositeStateAccessor_ = (() => $RenderStateShard$TransparencyStateShard);
}
