...
import { $EntityDimensions, $WalkAnimationState, $EntityType_, $Entity$RemovalReason, $MobSpawnType_, $PortalProcessor, $Pose_ } from "@package/net/minecraft/world/entity";
