...
declare module "@package/dev/latvian/mods/rhino/util/wrap" {
     ...
     */
    export type $TypeWrapper_<T> = { factory?: $TypeWrapperFactory_<any>, target?: $Class<any>, validator?: $TypeWrapperValidator_,  } | [factory?: $TypeWrapperFactory_<any>, target?: $Class<any>, validator?: $TypeWrapperValidator_, ];
