...
declare module "@package/dev/latvian/mods/kubejs/recipe/viewer" {
     ...
     */
    export type $RecipeViewerEntryType$Component_<T> = { type?: $TypeInfo_, empty?: $Predicate_<any>, streamCodec?: $StreamCodec<never, any>,  } | [type?: $TypeInfo_, empty?: $Predicate_<any>, streamCodec?: $StreamCodec<never, any>, ];
